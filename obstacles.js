...
function initObstacles(){
    ...
    for (let i = 0; i < 2; i++){
        let x = i * 300;
        carsArray.push(new Obstacle(x, canvas.height - grid * 3 - 20, grid * 1.5, grid, -1.3, 'car'));
    }
    //lane3
    for (let i = 0; i < 2; i++){
        let x = i * 400;
        carsArray.push(new Obstacle(x, canvas.height - grid * 4 - 20, grid * 2.7, grid, 1.6, 'car'));
    }
    //river4
    for (let i = 0; i < 2; i++){
        let x = i * 400;
